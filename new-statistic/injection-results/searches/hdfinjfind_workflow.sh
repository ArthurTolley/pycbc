...
#  Change the directory here to be where you want it to be
directory="./joint-${statistic}"
...
python /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/new-statistic/injection-results/get_search_trigger_files.py \
    ...
    --joint-time-file /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/new-statistic/injection-results/searches/joint_analysed_seconds.txt
