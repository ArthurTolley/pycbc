...
cd /home/arthur.tolley/EarlyWarning/pycbc/examples/live_earlywarning/
...
then
    ...
    simulate_strain H1 aLIGOMidLowSensitivityP1200087 1234 $gps_end_time
    simulate_strain L1 aLIGOMidLowSensitivityP1200087 2345 $gps_end_time
    simulate_strain V1 AdVEarlyLowSensitivityP1200087 3456 $gps_end_time
