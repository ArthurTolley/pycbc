...
pycbc_coinc_findtrigs \
    ...
    --fixed-ifo L1 \
    --output-file \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-COINC_week_1_no_inj.hdf \
    --nprocesses 15 \
...
pycbc_coinc_findtrigs \
    ...
    --fixed-ifo L1 \
    --output-file \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-COINC_week_2_no_inj.hdf \
    --nprocesses 15 \
    --timeslide-interval 0.1 \
    --verbose
...
pycbc_coinc_findtrigs \
    ...
    --fixed-ifo L1 \
    --output-file \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-COINC_week_1_with_inj.hdf \
    --nprocesses 15 \
    --verbose
...
pycbc_coinc_findtrigs \
    ...
    --fixed-ifo L1 \
    --output-file \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-COINC_week_2_with_inj.hdf \
    --nprocesses 15 \
    --verbose
...
pycbc_coinc_statmap \
    ...
    --ifos L1 H1 \
    --output-file \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-STATMAP_week_1_no_inj.hdf \
    --verbose
...
pycbc_coinc_statmap \
    ...
    --ifos L1 H1 \
    --output-file \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-STATMAP_week_2_no_inj.hdf \
    --verbose
...
pycbc_coinc_statmap_inj \
    ...
    --ifos L1 H1 \
    --output-file \
            /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-STATMAP_INJ_week_1_with_inj.hdf \
    --verbose
...
pycbc_coinc_statmap_inj \
    ...
    --ifos L1 H1 \
    --output-file \
            /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-STATMAP_INJ_week_2_with_inj.hdf \
    --verbose
...
pycbc_coinc_hdfinjfind \
    --trigger-files \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-STATMAP_INJ_week_1_with_inj.hdf \
    --injection-files \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/injection-frames/bbh_allo3pop_fixflow-1262192988-1262946475.xml \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/injection-frames/bbh_allo3pop_fixflow-1262946475-1263751886.xml \
    --injection-window 2.0 \
    --optimal-snr-column H1:optimal_snr_H1 L1:optimal_snr_L1 \
    --output-file \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-HDFINJFIND_week_1.hdf \
    --verbose
...
pycbc_coinc_hdfinjfind \
    ...
    --optimal-snr-column H1:optimal_snr_H1 L1:optimal_snr_L1 \
    --output-file \
      /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/complete_results/old-stat/H1L1-HDFINJFIND_week_2.hdf \
    --verbose
