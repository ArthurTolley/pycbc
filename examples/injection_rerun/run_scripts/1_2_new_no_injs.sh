...
# Restarting from new time
gps_start_time=1262658200
gps_end_time=1263600000

# Restarting again (3rd) from new time
gps_start_time=1262761000
gps_end_time=1263600000

# Restarting again (4th) from new time
gps_start_time=1263021800
gps_end_time=1263600000

# Restarting again (4th) from new time
gps_start_time=1263241600
gps_end_time=1263600000
...
--increment-update-cache \
    H1:/scratch/patrick.brockill/O3E2E_data/fill/H1 \
    L1:/scratch/patrick.brockill/O3E2E_data/fill/L1 \
--frame-src \
    H1:/scratch/patrick.brockill/O3E2E_data/fill/H1/* \
    L1:/scratch/patrick.brockill/O3E2E_data/fill/L1/* \
...
--output-path /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/1_2_new_no_injs \
