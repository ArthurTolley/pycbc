...
--increment-update-cache \
    H1:/scratch/arthur.tolley/O3InjectionFrames/64/H1/ \
    L1:/scratch/arthur.tolley/O3InjectionFrames/64/L1/ \
--frame-src \
    H1:/scratch/arthur.tolley/O3InjectionFrames/64/H1/* \
    L1:/scratch/arthur.tolley/O3InjectionFrames/64/L1/* \
...
--output-path /home/arthur.tolley/PyCBC_changes/temp_fit_infra/pycbc/examples/injection_rerun/1_2_old_with_injs \
